...
function custom_post_type_student()
{
    ...
    $args = array(
        ...
        'labels'                => $labels,
        'supports'              => array('title', 'thumbnail', 'editor'), // 'editor' for Block Editor
        'hierarchical'          => false,
        'public'                => true,
        'show_ui'               => true,
        'show_in_menu'          => true,
...
// Register Custom Taxonomy for Students
...
add_action('init', 'custom_taxonomy_student', 0);

// Add Terms "Designer" and "Developer" to Student Category Taxonomy
...
add_action('init', 'add_student_taxonomy_terms', 10);
